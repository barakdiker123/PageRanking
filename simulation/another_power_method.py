...
#plt.plot(steps, x1, 'r' , steps, x2,'b' ,  steps, x3 ,'g' )
#plt.savefig("power_method2.png")
#plt.show()

DG = nx.from_numpy_array(transition_matrix, create_using=nx.DiGraph)
nx.draw(DG)
plt.show()
